...
- [XGBoost](#xgboost)
- [Deep Learning Models CNN](#deep-learning-models-cnn)
  - [Experiments with different Hyperparameters](#experiments-with-different-hyperparameters)
  - [Retrain Fully Connected Layer](#retrain-fully-connected-layer)
  - [Retrain Entire Model](#retrain-entire-model)
...
The top score for this kaggle competition was 0.53751.
The metric is calculated with a top_k parameter.
The competition asks for a top_k of 100.
Simply, find the next 100 images that most closely resemble the input image.
...
Here are the various models I tried. 
...
- **Siamese CNN Resnet50 Fully Connected Layer Retrain**
  ...
  - Froze all layers excluding the Fully Connected layer
...
<img src="images/dl_model_metrics_comparison.png"/>

The *Siamese CNN Resnet50 ImageWeights Full** model perfomed the best amongst the deep learning models followed by the **Siamese CNN Resnet50 Fully Connected Layer Retrain** model.
The average precision for our best model was 0.276.
The next best model was 0.151.
I think it may be worth while to train the FC retrain model for more epochs given it's score versus the other models. 
...
<table>
  ...
  <tr>
    <td>Siamese CNN Resnet152 ImageWeights</td>
    <td>0.1190</td>
    <td>0.1291</td>
    <td>0.1360</td>
    <td>0.2491</td>
  ...
  <tr>
    <td>Siamese CNN Resnet50 ImageWeights Full</td>
    <td>0.2230</td>
    <td>0.2763</td>
    <td>0.2445</td>
    <td>0.3557</td>
...
1. Train XGBoost with more data
2. Train DL models on more powerful hardware
3. Try the loss function of the first place model
4. Train Frozen model for more epochs
